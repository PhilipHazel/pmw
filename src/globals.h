...
extern int32_t      out_pletden;
extern int32_t      out_pletnum;
extern int32_t      out_plet_highest;
extern int32_t      out_plet_highest_head;
...
extern uint32_t     pletstack[MAX_PLETNEST - 1];
extern uint32_t     pletstackcount;
