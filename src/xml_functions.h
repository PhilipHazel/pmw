...
// 
// extern void          misc_add_attrval_to_tree(tree_node **, item *, attrstr *);
...
// extern int           xml_get_attr_mils(item *, uschar *, int, int, int, BOOL);
...
// extern int           xml_get_mils(item *, uschar *, int, int, int, BOOL);
